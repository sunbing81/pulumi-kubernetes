...
class LimitRangeList(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(LimitRangeList, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'LimitRangeList':
        """
        ...
        return LimitRangeList(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[Sequence['outputs.LimitRange']]:
        """
